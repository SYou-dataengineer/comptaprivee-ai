...
def calculer_rapprochement_fiscal_2025(
    ...
    impot_total = arrondir_cent(
        ...
        + prestations_rrq_rpc.cotisation_fss + prestations_psv.recuperation
    )
    ...
    return RapprochementFiscal2025(
        ...
        retenue_federale=base.impot_federal_retenu + prestations_rqap.retenue_federale + prestations_ae.retenue_federale + prestations_rrq_rpc.retenue_federale + prestations_psv.retenue_federale,
        retenue_quebec=base.impot_quebec_retenu + prestations_rqap.retenue_quebec + prestations_ae.retenue_quebec + prestations_rrq_rpc.retenue_quebec + prestations_psv.retenue_quebec,
