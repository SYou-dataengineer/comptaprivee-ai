...
class ApplicationComptaPrivee(tk.Tk):
    ...
    def ouvrir_agent_fiscal(self) -> None:
        ...
        def invalider_profil_rqap() -> None:
            nonlocal rqap_confirme_courant, ae_confirme_courant, rrq_rpc_confirme_courant, derniere_estimation, dernier_rapport_pdf, rapport_fiscal_a_reexporter
            rqap_confirme_courant = False
            ae_confirme_courant = False
            rrq_rpc_confirme_courant = False
            derniere_estimation = None
        ...
        def ouvrir_prestations_rrq_rpc_2025() -> None:
            ...
            def appliquer_rrq_rpc():
                nonlocal rrq_rpc_confirme_courant, rqap_confirme_courant, ae_confirme_courant, derniere_estimation, dernier_rapport_pdf, rapport_fiscal_a_reexporter
                try:
        ...
        def ouvrir_prestations_ae_2025() -> None:
            ...
            def appliquer_ae():
                nonlocal ae_confirme_courant, rqap_confirme_courant, rrq_rpc_confirme_courant, derniere_estimation, dernier_rapport_pdf, rapport_fiscal_a_reexporter
                try:
                    if dossier_apercu is None or dossier_apercu is not self.dossier_fiscal_valide_courant:
                        raise ValueError("Le dossier a changé; préparez-le puis rouvrez ce formulaire.")
        ...
        def reconnaitre_documents_fiscaux() -> None:
            ...
            autres = len(classifications_fiscales) - t4 - rl1 - t4e - rl6 - t4ap - rl2
        ...
        def extraire_cases_documents_fiscaux() -> None:
            ...
            for chemin in documents_importes:
                ...
                if (
                    ...
                    not in {"T4", "RL-1", "T4E", "RL-6", "T4A(P)", "RL-2"}
                ):
                    continue
        ...
        def initialiser_dossier_fiscal() -> None:
            ...
            nonlocal accessibilite_domiciliaire_federale_courante
            nonlocal achat_habitation_federal_courant
            nonlocal cotisations_rpa_courantes, rqap_confirme_courant, ae_confirme_courant, rrq_rpc_confirme_courant
            nonlocal aidant_30450_federal_courant
            nonlocal aidant_enfant_federal_courant
            nonlocal derniere_estimation, dernier_rapport_pdf
            try:
        ...
        def preparer_dossier_fiscal_valide() -> None:
            ...
            try:
                for chemin in documents_importes:
                    ...
                    if (
                        classification.type_document in {"T4E", "RL-6", "T4A(P)", "RL-2"}
                        or type_nom in {"T4E", "RL-6", "T4A(P)", "RL-2"}
        ...
        ttk.Button(
            zone_actions,
            text="Reconnaître T4 / RL-1 / T4E / RL-6 / T4A(P) / RL-2",
